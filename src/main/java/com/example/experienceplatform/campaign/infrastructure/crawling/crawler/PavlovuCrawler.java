...
@Component
public class PavlovuCrawler implements CampaignCrawler {

    private static final Logger log = LoggerFactory.getLogger(PavlovuCrawler.class);
    private static final String BASE_URL = "https://pavlovu.com";
    private static final Pattern DAYS_LEFT_PATTERN = Pattern.compile("(\\d+)일\\s*남음");
    private static final String KEYWORDS_TAG = "파블로,체험단";
    ...
    public PavlovuCrawler(CrawlingProperties properties, JsoupClient jsoupClient,
    ...
    private CrawledCampaign parseDetailPage(CrawledCampaign campaign, Document doc) {
        ...
        // currentApplicants from sidebar
    ...
    private List<CrawledCampaign> generateMockData(CrawlingSource source) {
        ...
        for (int i = 1; i <= properties.getMockCount(); i++) {
            ...
            mocks.add(new CrawledCampaign(
                    source.getCode(), "pavlovu-" + i,
                    "[파블로] 체험단 캠페인 #" + i,
                    "파블로 체험단 설명 " + i, null,
                    "https://placehold.co/300x200?text=PAVLOVU+" + i,
                    BASE_URL + "/campaign/" + i,
                    cat, status,
                    3 + i % 6,
                    today.minusDays(3),
