...
class CampaignServiceTest {
    ...
    void searchCampaigns_withKeyword() {
        ...
        campaignService.searchCampaigns(
                new CampaignSearchCommand("맛집", null, null, null, 0, 12, "latest"));
    ...
    void searchCampaigns_withFilters() {
        ...
        campaignService.searchCampaigns(
                new CampaignSearchCommand(null, Set.of("REVU"), Set.of("FOOD"), "RECRUITING", 0, 12, "latest"));
    ...
    void searchCampaigns_invalidEnumIgnored() {
        ...
        campaignService.searchCampaigns(
                new CampaignSearchCommand(null, Set.of("INVALID_SOURCE"), Set.of("INVALID_CAT"), "INVALID_STATUS", 0, 12, "latest"));
    ...
    void searchCampaigns_emptyKeyword() {
        ...
        campaignService.searchCampaigns(
                new CampaignSearchCommand("  ", null, null, null, 0, 12, "latest"));
